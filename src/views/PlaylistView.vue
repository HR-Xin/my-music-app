<template>
  <div class="p-6">
    ...
    <div class="grid grid-cols-3 gap-4">
      <PlaylistCard v-for="playlist in paginatedPlaylists" :key="playlist.id" :playlist="playlist"
        @click="openDetail(playlist)" @edit="editPlaylist" @delete="deletePlaylist" />
    </div>
    ...
    <!-- 创建/编辑弹窗 -->
    <PlaylistEditor v-if="showEditor" :playlist="editingPlaylist" @save="savePlaylist" @close="closeEditor" />
...
// 所有歌单数据
const playlists = ref([
  { id: 1, title: '禅意之音', cover: '../assets/cover.png', description: '放松心情的旋律' },
...
const editingPlaylist = ref({ id: 1, title: '禅意之音', cover: '/assets/cover1.jpg', description: '放松心情的旋律' })
...
const editPlaylist = (playlist) => {
  editingPlaylist.value = { id: 1, title: '禅意之音', cover: '/assets/cover1.jpg', description: '放松心情的旋律' }
